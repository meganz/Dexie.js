...
import { safari14Workaround, safariMultiStoreFix } from '../../functions/quirks';
...
export function dexieOpen (db: Dexie) {
  ...
  return Promise.race([openCanceller, safari14Workaround(indexedDB).then(() => new Promise((resolve, reject) => {
